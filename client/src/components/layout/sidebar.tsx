    ...
    <Link href={href}>
      <div
        className={cn(
          ...
          active 
            ? "bg-primary/10 dark:primary/20 text-primary" 
            : "text-black dark:text-white hover:bg-muted dark:hover:bg-gray-800"
        )}
      >
...
export function Sidebar({ className }: SidebarProps) {
  ...
  if (isMobile && !expanded) {
    return (
      <div className={cn("bg-card dark:bg-gray-900 shadow-md w-full p-4 flex items-center justify-between", className)}>
        <Logo size="sm" />
  ...
  return (
    <div className={cn(
      "bg-card dark:bg-gray-900 shadow-md flex flex-col",
      isMobile 
      ...
      <div className="p-4 border-t border-border dark:border-gray-700 mt-auto">
        <div className="flex items-center">
          ...
          <Button 
            variant="ghost" 
            size="icon" 
            className="ml-auto text-gray-400 dark:text-muted-foreground hover:text-gray-600 dark:hover:text-gray-300"
