              ...
              <div className="mb-4 p-3 bg-red-50 dark:bg-red-900 rounded-lg">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    className="ml-4 border-red-200 dark:border-red-700 text-red-700 hover:bg-red-100"
                  >
                    ...
                    >
                      ...
                      {ver.comments && (
                        <div className="mt-3 bg-muted/30 p-2 rounded text-sm">
                          <p className="font-medium text-xs text-muted-foreground mb-1">Reviewer Comments:</p>
                          <p>{ver.comments}</p>
                        </div>
                      )}
              ...
              <div className="max-h-32 overflow-y-auto">
                <ul className="space-y-1 text-sm text-red-600">
                  {selectedVersionIds.map(id => {
                    ...
                    return version ? (
                      <li key={id} className="flex items-center justify-between gap-2 p-2 bg-card/50 rounded">
                        <div className="flex items-center gap-2">
