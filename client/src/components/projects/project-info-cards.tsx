                ...
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                  <div 
                    className={`rounded-full h-2 ${
                      complete ? 'bg-green-50 dark:bg-green-9000' : progress > 0 ? 'bg-yellow-500' : 'bg-red-50 dark:bg-red-9000'
                    }`} 
      ...
      <Card>
        <CardContent className="p-4">
          ...
          <div className="space-y-4">
            <div>
              <h4 className="text-sm font-medium text-muted-foreground mb-2">Permit Specialists</h4>
              <div className="flex items-center">
                <Avatar className="h-8 w-8">
                  <AvatarFallback className="bg-primary/10 dark:primary/20 text-primary">ST</AvatarFallback>
                </Avatar>
                <div className="ml-3">
            ...
            <div>
              <h4 className="text-sm font-medium text-muted-foreground mb-2">Stakeholders</h4>
              {stakeholders.length > 0 ? (
                <div className="space-y-3">
                  {stakeholders.map(stakeholder => (
                    <div key={stakeholder.id} className="flex items-center">
                      <Avatar className="h-8 w-8">
                        <AvatarFallback className="bg-gray-200 dark:bg-gray-700 text-gray-700">
                ...
                <div className="text-sm text-muted-foreground italic">No stakeholders assigned</div>
              )}
            </div>
