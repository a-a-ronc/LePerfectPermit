  ...
  return (
      <div className="p-6">
          <div className="mb-6">
            ...
            <p className="text-muted-foreground dark:text-gray-400">Welcome back, {userData?.fullName || userData?.username || 'User'}. Here's an overview of your permit projects.</p>
          </div>
            ...
            {isLoading ? (
              ...
              <>
                <Card>
                  <CardContent className="p-4">
                    <div className="flex items-center">
                      <div className="rounded-full bg-primary/10 dark:primary/20 p-3">
                ...
                <Card>
                  <CardContent className="p-4">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <h3 className="text-muted-foreground text-sm font-medium">Action Required</h3>
          ...
          <Card className="mb-6">
            <CardContent className="p-4">
              ...
              <div className="flex flex-wrap gap-2">
                <Button variant="outline" className="bg-primary/10 dark:primary/20 text-primary">All Projects</Button>
