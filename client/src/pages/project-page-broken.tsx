  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex-grow overflow-hidden">
        {/* Top Navigation Bar */}
        <div className="bg-card p-4 shadow-sm flex items-center justify-between">
          <nav className="flex" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2">
              <li>
                <Link href="/">
                  <div className="text-muted-foreground hover:text-gray-700 cursor-pointer">Dashboard</div>
                </Link>
              </li>
