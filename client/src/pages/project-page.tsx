      ...
      <div className="bg-white dark:bg-gray-800 p-4 shadow-sm flex items-center justify-between">
          <nav className="flex" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2">
              <li>
                <Link href="/">
                  <div className="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 cursor-pointer">Dashboard</div>
                </Link>
              </li>
              <li className="flex items-center">
                ...
                <span className="ml-2 text-gray-500 dark:text-gray-400">Projects</span>
              </li>
            </ol>
          </nav>
      </div>
