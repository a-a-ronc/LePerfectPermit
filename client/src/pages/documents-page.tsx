  ...
  const columns: ColumnDef<DocumentRow>[] = [
    {
      ...
      cell: ({ row }) => (
        <div>
          ...
          <div className="text-sm text-muted-foreground">{formatDocumentCategory(row.original.category)}</div>
        </div>
      ),
    },
    {
      ...
      <div className="p-6 overflow-auto h-[calc(100vh-64px)]">
          <div className="mb-6 flex flex-wrap justify-between items-center">
            <div>
              ...
              <p className="text-muted-foreground">View and manage all documents across all projects.</p>
            </div>
          </div>
